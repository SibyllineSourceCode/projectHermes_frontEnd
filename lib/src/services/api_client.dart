...
class ApiClient {
  ...
  final String
  baseUrl; // e.g. https://us-central1-project-hermes-d667b.cloudfunctions.net/api
  ...
  Future<Map<String, dynamic>> patchMe({required String username}) =>
      _authedPost('/me', {'username': username});
  ...
  Future<Map<String, dynamic>> turnCredentials() =>
      _authedGet('/turn/credentials');

  Future<Map<String, dynamic>> getLists() => _authedGet('/lists');

  Future<Map<String, dynamic>> postLists({required String title}) =>
      _authedPost('/lists', {'title': title});

  Future<Map<String, dynamic>> updateLists({
